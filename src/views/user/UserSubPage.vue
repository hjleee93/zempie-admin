        ...
        <q-card v-if="!$apollo.queries.userGet.loading">
            <q-card-section>
                ...
                <div>
                    ...
                    <q-btn color="grey" class="q-mr-sm" label="정지" />
                    <q-btn color="grey" outline class="q-mr-sm" label="정지 취소" />
                    <q-btn color="red" class="q-mr-sm" label="삭제" />
                </div>
            </q-card-section>
            ...
            <q-card-section v-if="!$apollo.queries.userInquiryGet.loading">
                <div class="text-h5 q-mb-md">
                    문의 목록
                </div>
