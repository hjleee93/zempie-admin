            ...
            <div class="q-mb-md">
                ...
                <div>
                    <div v-if="game.url_game != null" class="float-left">
                        <q-btn class="q-mr-md" color="primary" label="비활성화" @click="hideGame" v-if="game.enabled" />
                        <q-btn class="q-mr-md" color="primary" label="활성화" @click="showGame" v-else />
                    </div>
                    
                    <q-btn class="q-mr-md" color="red" label="삭제" @click="deleteGame" />
                    <q-btn class="q-mr-md" color="primary" label="도전게임으로 이동" @click="moveGame" />
                </div>
            </div>
        </div>
...
export default class extends Vue {
    ...
    get gameTags(){
        console.log(this.game.hashtags);
