            ...
            <q-card>
                ...
                <q-tab-panels v-model="tab" animated>
                    <q-tab-panel name="info">
                        <CommunityCreate :communityId="communityId" v-if="$store.getters.editOpen"></CommunityCreate>
                        <CommunityInfo :communityId="communityId" v-else></CommunityInfo>
                    </q-tab-panel>
...
import Subscribers from "./_subscribers.vue"
...
@Component({
    components: {CommunityInfo, ChannelList, Subscribers, BlockMembers, KickMembers, CommunityCreate},
})
