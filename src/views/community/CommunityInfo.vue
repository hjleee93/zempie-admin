<template>
    <div>
        ...
        <div class="row">
            ...
            <div class="col-9">{{ community.member_cnt }}명</div>
        </div>

        <div class="row">
            <div class="col-3">포스팅 수</div>
            <div class="col-9">{{ community.posts_cnt }}개</div>
        </div>
        <!-- <div class="row">
        ...
        <div class="q-mt-sm" style="text-align: right">
            ...
            <q-btn style="background: red; color: white" @click="deleteConfirm"
                >삭제</q-btn
            >
        </div>
    ...
    fetch() {
        this.$api.group
            ...
            .then(async (res) => {
                ...
                this.createdDate = moment(this.community.createdAt)
                    .locale("ko")
                    .format("LL");
